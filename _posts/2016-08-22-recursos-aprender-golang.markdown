...
<hr />
  <ul class="ulposts">
    ...
    <li>Go en Platzi: otra de las mejores plataformas de e-learning en la actualidad aunque sus cursos son de pago. Los profesores son expertos de nuestro sector, <a href="https://platzi.com/cursos/go-basico/" title="Go en Platzi" target="_blank">enlace</a>.</li>
  </ul>
<hr />
